...
public class TelaReservas extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(comboAluno, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(comboProfessor, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        ...
        ArrayList resultados = reservaController.listarReservas();
        
        model.setRowCount(0);
        
        for (int i = 0; i < resultados.size(); i++){
            
            Reserva l = (Reserva) resultados.get(i);
            model.addRow(new Object[]{Integer.parseInt(l.getId()), l.getIdLivro(), l.getLogin(), l.getDataInicial(), l.getDataDeEntrega()});
        }
    }//GEN-LAST:event_btnListarActionPerformed

    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        // TODO add your handling code here:
        NovoReserva frame2 = new NovoReserva();
    ...
    private void tabelaReservasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaReservasMouseClicked
        // TODO add your handling code here:
        linhaSelecionadaAnteriormente = tabelaReservas.getSelectedRow();
        colunaSelecionadaAnteriormente = tabelaReservas.getSelectedColumn();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (tabelaReservas.getSelectedRow() >= 0) {
            String id = Integer.toString((Integer) tabelaReservas.getValueAt(linhaSelecionadaAnteriormente, 0));

            reservaController.deletarReserva(id);

            int a = tabelaReservas.getSelectedRow();
            model.removeRow(a);
        }
        else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (alunoClicado) {
            ...
            DefaultTableModel model = (DefaultTableModel) tabelaReservas.getModel();
            ArrayList resultados = reservaController.listarReservasPorUsuario(loginAluno);
            model.setRowCount(0);
            for (int i = 0; i < resultados.size(); i++) {
            ...
            DefaultTableModel model = (DefaultTableModel) tabelaReservas.getModel();
            ArrayList resultados = reservaController.listarReservasPorUsuario(loginProfessor);
            model.setRowCount(0);
            for (int i = 0; i < resultados.size(); i++) {
