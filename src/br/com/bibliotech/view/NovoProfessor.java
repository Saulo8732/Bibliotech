...
public class NovoProfessor extends javax.swing.JFrame {
    private ProfessorController livroController;
    private boolean salvo = false;
    /**
     * Creates new form NovoProfessor
     */
    public NovoProfessor() {
        livroController = new ProfessorController();
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 10, 130, -1));
        ...
        jPanel1.add(btnSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 10, 130, -1));

        txtSenha.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jPanel1.add(txtSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, 130, -1));

        txtLogin.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jPanel1.add(txtLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 50, 130, -1));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        livroController.salvarProfessor(nome, login, senha);
        System.out.println(nome + " " + login + " " + senha);
        salvo = true;
        TelaProfessores m = new TelaProfessores();
        m.setVisible(true);
        this.hide();
