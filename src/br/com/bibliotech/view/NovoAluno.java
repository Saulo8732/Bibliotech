...
public class NovoAluno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 130, -1));
        ...
        jPanel1.add(btnSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 10, 110, -1));

        txtSenha.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jPanel1.add(txtSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, 130, -1));

        txtLogin.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jPanel1.add(txtLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 50, 130, -1));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        alunoController.salvarAluno(nome, login, senha);
        System.out.println(nome + " " + login + " " + senha);
        salvo = true;
        TelaAlunos m = new TelaAlunos();
        m.setVisible(true);
        this.dispose();
